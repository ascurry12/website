...
const About = () => {
  ...
  var traitIcons = {
    Adventurous: "/assets/Computer3.png",
    Foodie: "/assets/Computer3.png",
    Creative: "/assets/Computer3.png",
    "Dog Lover": "/assets/Computer3.png",
    Ambitious: "/assets/Computer3.png",
  };
  var skills = [
    "React",
    "ASP.NET",
  ...
  return (
    <div className="about-container">
      <div className="about-head">
        ...
        <div>
          <img src="/assets/me.JPG" className="profile-pic"></img>
        </div>
      </div>
